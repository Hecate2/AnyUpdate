...
Finally there is an experimental project `AnyUpdateRenter.py` (`0x9cf19e43333a0b4513bd61e2316b40ecb9454a9b` on testnet) which allows you to rent contracts defined by `AnyUpdateSafeForRent.py` (instance 0 on testnet `0xb82bb0da46129f219d657cb6d7fbb22415efc502` that does not `findStorage`, instance 1 on testnet `0x6d13f393c90fa7182974a2b4d212e82bd0ccaf24` that supports `findStorage`, instance 2 on testnet `0xc2319a0e9c469598ba8c9425b56bcc39315c4c3e` that supports `findStorage` and `updateAndCallAnother`).
