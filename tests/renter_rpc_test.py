...
user1client = TestClient(target_url, contract_for_rent_hash, user1_hash, user1_address, 'user1.json', '1')
user1client.openwallet()
user1client.invokefunction_of_any_contract(contract_for_rent_hash, 'anyUpdate0', [nef_file, manifest, 'putNef'], relay=False)
